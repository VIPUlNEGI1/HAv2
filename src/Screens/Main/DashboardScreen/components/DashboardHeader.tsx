...
const styles = StyleSheet.create({
  ...
  headerBackground: { 
    ...
    marginLeft: 0,
    marginRight: 0,
    marginTop: Platform.OS === 'ios' ? -moderateScale(45) : -moderateScale(20),
  ...
  searchContainer: {   paddingHorizontal: moderateScale(20) },
  searchBar: { flexDirection: 'row', alignItems: 'center', borderRadius: moderateScale(15), paddingHorizontal: moderateScale(16), height: verticalScale(50), shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 5, elevation: 3 },
